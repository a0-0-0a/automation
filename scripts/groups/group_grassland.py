...
GROUPS = {
    "open_steppe": {
        "locations": [
            "Mongolian steppe Gobi, endless rolling golden natural grassland",
            "Kazakh steppe, flat endless natural grass stretching to horizon",
            "Patagonian steppe Argentina, windswept golden natural grass plains",
            "Tibetan plateau Qinghai, high altitude natural grass plateau",
            "South African highveld, open golden natural grass plateau",
            "Kansas tallgrass prairie USA, rolling natural sea of tall grass",
            "Hungarian puszta, flat treeless natural grass plain",
        ],
        "times": ALL_TIMES,
    ...
    "wildflower_meadow": {
        "locations": [
            "Swiss Alpine meadow, natural wildflowers above the cloud layer",
            "California poppy reserve, vivid natural orange rolling hills",
            "New Zealand tussock grassland, golden natural tussock slopes",
            "Colorado Rocky Mountain meadow, natural wildflowers and peaks",
            "Norwegian mountain meadow, natural wildflowers and open sky",
            "Austrian Alpine meadow, natural wildflowers and distant peaks",
        ],
        "times": ALL_TIMES,
        "compositions": COMPOSITIONS_GRASS,
        "seasons": [
